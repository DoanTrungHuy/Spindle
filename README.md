...
A high-performance, multithreaded Key-Value store written in Modern C++ (C++20). 
...
FetchContent_MakeAvailable(KVStore)

# Link it to your executable
add_executable(my_app main.cpp)
target_link_libraries(my_app PRIVATE kv_store)
```
...
The project includes a sample application `kv_store_app` that demonstrates how to use the library.
